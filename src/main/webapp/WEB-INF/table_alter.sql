...
--ALTER TABLE instaclone_img
--ADD(id NUMBER PRIMARY KEY);
--ALTER TABLE instaclone_img
--ADD(savePath VARCHAR2(1000));
--ALTER TABLE instaclone_img
--DROP COLUMN imgBase64;
--ALTER TABLE instaclone_board
--ADD(writer VARCHAR2(100) NOT NULL);
--DELETE FROM instaclone_img;

--ALTER TABLE instaclone_user
--ADD(thumbnail VARCHAR2(1000));
